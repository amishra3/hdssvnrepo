...
public static ResourceNode getResourceNode(Resource resource,String[] contenttype,TagManager tagManager) {
		...
		if(properties.containsKey("dc:hdstitle")){
			resourceNode.setResourceTitle(properties.get("dc:hdstitle").toString());
		} else if (properties.containsKey("dc:title")) {
