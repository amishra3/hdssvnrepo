...
<div class="col-md-6">
    <div class="community-common-box">
        ...
        <div class="comm-read-more">
            <a href="${properties.breadmorelink}" class="animateLink" target="${properties.bopeninnew?'_blank':'_self'}">${properties.breadmore} <span class="glyphicon glyphicon-menu-right animateIcon" aria-hidden="true"></span></a>
        </div>
    </div>
</div>