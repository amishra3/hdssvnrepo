  		...
  		<div class="footer-blue col-xs-12 col-sm-12 col-md-12 col-lg-12">
  			<div class="footer-container content-container col-md-12">
                <div class="talk">
  				...
  				<div class="buttons">
  					<a href="${fn:contains(buttonUrl, 'http')?'':domain}${buttonUrl}" rel="${properties.mform?'iframemodal':''}" class="information btn-square -white hidden-md hidden-lg" target="${properties.contactusbannerurltargettype?'_blank':'_self'}">${properties.contactusbannerbuttonlabel}</a>
