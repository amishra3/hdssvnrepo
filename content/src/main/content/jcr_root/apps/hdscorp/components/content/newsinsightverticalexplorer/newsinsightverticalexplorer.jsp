...
<sling:adaptTo adaptable="${resource}" adaptTo="com.hdscorp.cms.slingmodels.NewsInsightVerticalExplorerModel" var="newsInsightVerticalExplorer" />




					<div class="news-insight-explore-spotlight spotlight1" style="background-image: url('${newsInsightVerticalExplorer.backgroundImagePath}')">
                                <div class="spotlight-mobile spotlight1 hidden-md hidden-lg"></div>
                                <div class="spotlight-content">
                                    <div class="icon hidden-xs hidden-sm">
                                        <img src="${newsInsightVerticalExplorer.iconImagePath}" alt="" title="">
                                    </div>
                            ...
                            <div class="news-insight-explore-spotlight spotlight-normal">
                                <div class="spotlight-content">
                                    ...
                                    <c:choose>
									 ...
									 <a href="${newsInsightVerticalExplorer.targetBottomURL}" target="_blank" class="animateLink">${newsInsightVerticalExplorer.readMoreBottomLabel}<span class="glyphicon glyphicon-menu-right animateIcon" aria-hidden="true"></span></a>
                                        </c:when>
                                        <c:otherwise>
                                        <a href="${newsInsightVerticalExplorer.targetBottomURL}" class="animateLink">${newsInsightVerticalExplorer.readMoreBottomLabel}<span class="glyphicon glyphicon-menu-right animateIcon" aria-hidden="true"></span></a>
                                        </c:otherwise>
                                    </c:choose>
