...
<sling:adaptTo adaptable="${resource}" adaptTo="com.hdscorp.cms.slingmodels.TrainingSearchCoursesModel" var="trainingSearchCoursesModel" />

<c:set var="tabList" value="<%=PageUtils.convertMultiWidgetToList(properties,"locationlabel-locationid")%>" />
					...
					<div class="service-support-main training clearfix">
						<div class="content-container clearfix">
							<div class="col-sm-12">
								...
								<div class="col-sm-6">
									<div class="serv-training-overview last">
										<h3>${trainingSearchCoursesModel.searchforcourseslabel}</h3>
										<div class="training-search">
											<input type="text" placeholder="${trainingSearchCoursesModel.searchkeyword}">
										...
										<div class="col-sm-12">
													<div class="col-sm-6 center">
														<div class="btn-group"> 
																<button aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="btn dropdown-toggle service-btn" type="button">${trainingSearchCoursesModel.selectlocationlabel}<span aria-hidden="true" class="glyphicon glyphicon-chevron-down"></span></button> 	
