        ...
        bindClick: function() {
            ...
            $(document).on('click','.pr-search .glyphicon-search', function(event) {             
                ...
                if ($(".pr:visible").length === 0) {                    
                    ...
                    $('#loadPressAwrads').append('<div class="no-matched-result" style="padding: 50px 0; text-align: center;"><strong>Can’t Find What You’re Looking For?</strong><br>Please change your search criteria and try again.</div>');
                }
                }, 1000);
            });
